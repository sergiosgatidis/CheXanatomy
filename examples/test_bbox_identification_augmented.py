#!/usr/bin/env python3
"""
Test bbox_identification with augmentation
"""
...
def test_bbox_identification_with_augmentation():
    """Test bbox_identification task with augmentation"""
    ...
    print("Testing bbox_identification with augmentation...")
    ...
    # Generate samples
    original_sample = original_generator.generate_sample('bbox_identification', structure)
    augmented_sample = augmented_generator.generate_sample('bbox_identification', structure)
    ...
    ax2.set_title(f'Augmented (Scale: {aug_params["scale_factor"]:.3f})\\n"{augmented_sample.prefix}"\\nAnswer: {augmented_sample.suffix}')
    ax2.axis('off')
    
    plt.tight_layout()
    plt.savefig('bbox_identification_augmentation_test.png', dpi=150, bbox_inches='tight')
    plt.show()
    
    print("\\n✅ bbox_identification task with augmentation working correctly!")

if __name__ == "__main__":
    test_bbox_identification_with_augmentation()